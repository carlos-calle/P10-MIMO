...
- Usar canal Rayleigh simplificado a partir de perfiles ITU discretizados, con `ITU Pedestrian A` como perfil activo por defecto.
...
- Simplificar los CRS LTE a pilotos QPSK deterministas en todos los simbolos OFDM, con separacion de 6 subportadoras, para estimacion de canal en frecuencia.
